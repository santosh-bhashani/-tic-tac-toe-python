...
def cpu():
    if ("x11" in list and "x13" in list and "x15" not in list and "1 5" in listo) :
        ...
        sea(1,1)
    elif ("x13" in list and "x33" in list and "x51" not in list and "5 1" in listo):
        sea(5,1)
        
    elif ("x13" in list and "x51" in list and "x33" not in list and "3 3" in listo):
        sea(3,3)
    elif ("x33" in list and "x51" in list and "x13" not in list and "1 3" in listo):
        sea(1,3)
    else:
        if count.get()==3:
...
def cpumain():
    if ("o11" in list and "o13" in list and "o15" not in list and "1 5" in listo) :
        ...
        sea(1,1)
    elif ("o13" in list and "o33" in list and "o51" not in list and "5 1" in listo):
        sea(5,1)
        
    elif ("o13" in list and "o51" in list and "o33" not in list and "3 3" in listo):
        sea(3,3)
    elif ("o33" in list and "o51" in list and "o13" not in list and "1 3" in listo):
        sea(1,3)
    else:
        cpu()
